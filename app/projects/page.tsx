	...
	return (
		<main className={styles.main}>
			...
			<div className={styles.text}>
				...
				>
					<Image className={styles.gif} src={myGif} alt="Demo Gif" width={480} height={320} /> <br></br><br></br>	
				</a>
				...
				<a href="https://github.com/Voluptua/pokeemerald/tree/start_menu_1"
				   ...
				   rel="noopener norefeerer"
				>
					<Image className={styles.gif} src={myGif} alt="Demo Gif" width={480} height={320} /> 
				</a>
